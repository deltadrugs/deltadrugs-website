(function () {
  ...
  var T = {
    en: {
      ...
      gate_tagline: 'Healthcare. Simplified.',
      gate_sub: 'Choose your experience',
      gate_patient_title: "I'm a Patient or Family Member",
      gate_patient_sub: 'Get supplies delivered to your door — we handle insurance and everything else',
      gate_pro_title: "I'm a Healthcare Professional",
      gate_pro_sub: 'Submit referrals in minutes and track orders through our provider portal',
      gate_partner_title: "I'm a Referral Partner",
      gate_partner_sub: 'WIC centers, hospitals, and health departments across California',
      gate_enter: 'Enter →',
      ...
      patient_hero_title: 'Healthcare. Simplified.',
      patient_hero_sub: 'We sort. We deliver. You live better.',
      ...
      pro_hero_title: 'Referrals. Simplified.',
      pro_hero_sub: 'Submit in minutes. We handle everything after that.',
      pro_bullet_1: 'Online portal available 24/7',
      pro_bullet_2: 'Insurance verification handled',
      pro_bullet_3: 'Real-time order tracking',
    ...
    es: {
      ...
      gate_tagline: 'Tu Salud. Sin Complicaciones.',
      gate_sub: 'Elige tu experiencia',
      gate_patient_title: 'Soy Paciente o Familiar',
      gate_patient_sub: 'Recibe tus productos en casa — nosotros manejamos el seguro y todo lo demás',
      gate_pro_title: 'Soy Profesional de Salud',
      gate_pro_sub: 'Envía referidos en minutos y rastrea pedidos en nuestro portal',
      gate_partner_title: 'Soy Socio de Referidos',
      gate_partner_sub: 'Centros WIC, hospitales y departamentos de salud en California',
      gate_enter: 'Entrar →',
      ...
      patient_hero_title: 'Tu Salud. Sin Complicaciones.',
      patient_hero_sub: 'Nosotros tramitamos. Nosotros entregamos. Tú vives mejor.',
      patient_bullet_1: 'Tu doctor te da el referido',
      ...
      pro_hero_title: 'Referidos. Sin Complicaciones.',
      pro_hero_sub: 'Envía en minutos. Nosotros nos encargamos del resto.',
      pro_bullet_1: 'Portal en línea disponible 24/7',
      pro_bullet_2: 'Verificación de seguro incluida',
      pro_bullet_3: 'Rastreo de pedidos en tiempo real',
