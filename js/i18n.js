(function () {
  ...
  var T = {
    en: {
      ...
      gate_tagline: 'California\'s Dedicated Medi-Cal & Institutional Pharmacy Hub.',
      ...
      pro_bullet_1: '<strong>Automated Prior Authorization Engine:</strong> Don\'t waste clinic payroll fighting state rejections. Upload the script and chart notes—our dedicated team handles the rest.',
      pro_bullet_2: '<strong>The Total Care Bundle:</strong> We seamlessly coordinate and package niche medications, complex enteral formulas, and DME incontinence supplies into a single delivery.',
      pro_bullet_3: '<strong>100% California-Focused Logistics:</strong> Direct same-day delivery within our local radius and guaranteed overnight shipping to the most remote areas of the state.',
    ...
    es: {
      ...
      gate_tagline: 'Tu Centro Dedicado de Farmacia Medi-Cal e Institucional de California.',
      ...
      pro_bullet_1: '<strong>Motor de Autorización Previa Automatizado:</strong> No tires el dinero de la clínica peleando con rechazos del estado. Sube la receta y las notas—nuestro equipo dedicado se encarga del resto.',
      pro_bullet_2: '<strong>Paquete de Cuidado Total:</strong> Coordinamos y empacamos sin complicaciones medicamentos especializados, fórmulas enterales complejas, y suministros de incontinencia DME en una sola entrega.',
      pro_bullet_3: '<strong>Logística 100% Enfocada en California:</strong> Entrega el mismo día en nuestro radio local y envío garantizado al día siguiente hasta las zonas más remotas del estado.',
      ...
      partner_bullet_3: '<strong>Entrega Nocturna a la Puerta:</strong> Nos encargamos completamente de los envíos pesados, llegando directo al portal de la familia en cualquier parte de California sin costo para ellos.',
