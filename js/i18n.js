(function () {
  ...
  var T = {
    en: {
      ...
      gate_patient_title: 'I am a Patient / Family Member',
      gate_patient_sub: 'Emergency local pickup available. Free statewide home delivery on all covered medications, formulas, and supplies.',
      gate_pro_title: 'I am a California Clinician / FQHC',
      gate_pro_sub: 'Access Delta Connect to submit referrals, bypass administrative paperwork, and track clinical status.',
      gate_partner_title: 'I am an Institutional / WIC Partner',
      gate_partner_sub: 'Centralized specialty infant formula allocation and rapid prior authorization processing.',
      gate_enter: 'Enter →',
      ...
      pro_bullet_1: '<strong>Automated Prior Authorization Engine</strong><br>Don\'t waste clinic payroll fighting state rejections. Upload the script and chart notes — our dedicated Clinical Access Team handles the rest.',
      pro_bullet_2: '<strong>The Total Care Bundle</strong><br>We coordinate and package niche medications, complex enteral nutrition formulas, and DME incontinence supplies into a single, unified delivery.',
      pro_bullet_3: '<strong>100% California-Focused Logistics</strong><br>Built for speed. Direct same-day delivery within our local radius and guaranteed overnight shipping to the most remote areas of the state.',
      ...
      partner_hero_title: 'Partnerships. Built on Trust.',
      partner_hero_sub: 'California institutions choose us because we deliver — every time.',
      partner_bullet_1: 'WIC-approved supplier',
      partner_bullet_2: 'Medi-Cal and Medicare accepted',
      partner_bullet_3: 'Statewide home delivery',
    ...
    es: {
      ...
      gate_tagline: 'Tu Centro de Farmacia Medi-Cal e Institucional Especializada de California.',
      gate_sub: 'Elige tu portal abajo para coordinar tu cuidado directo y recibir en todo el estado.',
      gate_patient_title: 'Soy Paciente / Familiar',
      gate_patient_sub: 'Recogida local de emergencia disponible. Entrega gratis a domicilio en todo California — medicamentos, fórmulas y suministros cubiertos.',
      gate_pro_title: 'Soy Clínico en California / FQHC',
      gate_pro_sub: 'Entra a Delta Connect para mandar referidos, saltarte el papeleo, y darle seguimiento clínico.',
      gate_partner_title: 'Soy Socio Institucional / WIC',
      gate_partner_sub: 'Asignación centralizada de fórmula infantil especializada y autorizaciones previas rapidísimas.',
      gate_enter: 'Entrar →',
      ...
      pro_bullet_1: '<strong>Motor de Autorización Previa Automatizado</strong><br>No tires el dinero de la clínica peleando con rechazos del estado. Sube la receta y las notas — nuestro equipo clínico se encarga del resto.',
      pro_bullet_2: '<strong>Paquete de Cuidado Total</strong><br>Coordinamos y empacamos medicamentos especializados, fórmulas de nutrición enteral complejas, y suministros de incontinencia DME en una sola entrega unificada.',
      pro_bullet_3: '<strong>Logística 100% Enfocada en California</strong><br>Hecho para la velocidad. Entrega el mismo día en nuestro radio local y envío garantizado al día siguiente hasta las zonas más remotas del estado.',
      ...
      partner_hero_title: 'Alianzas. Basadas en Confianza.',
      partner_hero_sub: 'Las instituciones de California nos eligen porque cumplimos — siempre.',
      partner_bullet_1: 'Proveedor aprobado por WIC',
      partner_bullet_2: 'Aceptamos Medi-Cal y Medicare',
      partner_bullet_3: 'Entrega a domicilio en todo el estado',
